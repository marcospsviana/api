...
[![codecov](https://codecov.io/gh/marcospsviana/api/branch/main/graph/badge.svg?token=api_token_here)](https://codecov.io/gh/marcospsviana/api)
[![CI](https://github.com/marcospsviana/api/actions/workflows/main.yml/badge.svg)](https://github.com/marcospsviana/api/actions/workflows/main.yml)

Awesome api created by marcospsviana
...
[![Open in Gitpod](https://gitpod.io/button/open-in-gitpod.svg)](https://gitpod.io/#https://github.com/marcospsviana/api)

### from source
```bash
git clone https://github.com/marcospsviana/api api
cd api
make install
```
...
```bash
PROJECT_NAME_ENV=production api run
```
